...
std::string QuackingDuck::Ask(std::string question) {
    ...
    chat_.SetSystemContext("You are a helpful assistant that can generate Postgresql code based on the user input. You do not respond with any human readable text, only SQL code.");    
